...
parfor i = 1:nDelfiData 
    ...
    timeVector = [dateStart:dateEnd]';% 2019.12.15-2021.12.11
    ...
    adjacencyDaily = zeros(size(nation.county.bkg250KrsArs, 1), size(nation.county.bkg250KrsArs, 1), size(timeVector, 1)); % 县的大小*县的大小*时间
